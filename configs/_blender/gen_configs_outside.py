...
for scene_type in ["wonderjourney", "scenescape", "sphericaldreamer"]:
    ...
    CFG_DIR = Path(f"/home/a.schnepf/phd/SphericalDreamer/configs/_blender/outside/{scene_type}")
    CONFIG_IN = "/home/a.schnepf/phd/SphericalDreamer/configs/_blender/example.yaml"
