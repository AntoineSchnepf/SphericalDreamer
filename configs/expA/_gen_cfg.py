PROMPTS = {
    "train": "my primpts...An empty train interior with long straight corridors extending forward and continuing behind the observer, rows of seats, windows reflecting dim exterior light, cinematic lighting, realistic textures, immersive enclosed space.",
